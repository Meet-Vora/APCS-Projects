...
public class NewHTMLRender {
	...
	public static void main(String[] args) {
		...
		NewHTMLRender nhf = new NewHTMLRender();
		nhf.run(args);
	}
	
	/**
	 *	Opens the HTML file specified on the command line then inputs each line 
	 *	and creates an array of Strings that comprise of tokens produced by 
	 *	HTMLUtilities.
	...
	public void sortTokens(String[] tokens, int permArray) {
		...
		while (counter < permArray) {
			...
			// Print bold if bold token detected
			...
			// Print italics if italics token detected
			...
			// Print text as formatted if preformat token detected
	...
	public void findEndHeader(char headerNum) {
		...
		// find corresponding header tag to end sequence
	...
	/**
	 *	Processes bold or italic tags, and determines which one to format. Using
