...
public class SnakeGame {
	...
	public void run() {
		...
		do {
			...
			// if f, then save the game progress
			if (input.equals("f"))
				isQuit = saveGame();
			...
			// quit the game
				...
				// prompt user for input if they do not enter any of the commands
				// in the game, y, or n
				do {
					...
					if (quit.equalsIgnoreCase("y"))
						isQuit = true;
				} while(!isQuit && !input.equals("w") && !input.equals("s") && !input.equals("d") && 
					!input.equals("a") && !input.equals("h") && !input.equals("f") && 
					!input.equals("r") && !input.equals("q") && !input.equals("n"));
			}
			// load the progress from the text file if "r"
			else if (input.equals("r"))
				loadGame();
			// move the snake if any of the rest of the commands are given
			else {
	...
	public boolean validLocation() {
		...
		// checks if the target location is equal to any part of the snake's
		// location
	...
	public boolean checkForCollision(char movement) {
		...
		// check if snake runs into border based on movement and location near
		// the border
