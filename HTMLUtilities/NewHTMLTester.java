...
public class NewHTMLTester {

	private NewHTMLUtilities nutil;			// HTMLUtilities used in tester
	
	public NewHTMLTester() {
		nutil = new NewHTMLUtilities();
	}
	
	public static void main(String[] args) {
		NewHTMLTester nht = new NewHTMLTester();
		nht.run(args);
	}
	...
	public void run(String[] args) {
		...
		while (input.hasNext()) {
			...
			System.out.println("\n" + line);
			String [] tokens = nutil.tokenizeHTMLString(line);
			nutil.printTokens(tokens);
		}
		input.close();
	}
}