...
public class HTMLTesterWithEnum {

	private HTMLUtilitiesWithEnum utilwe;			// HTMLUtilities used in tester
	
	public HTMLTesterWithEnum() {
		utilwe = new HTMLUtilitiesWithEnum();
	}
	
	public static void main(String[] args) {
		HTMLTesterWithEnum htwe = new HTMLTesterWithEnum();
		htwe.run(args);
	}
	...
	public void run(String[] args) {
		...
		while (input.hasNext()) {
			...
			System.out.println("\n" + line);
			String [] tokens = utilwe.tokenizeHTMLString(line);
			utilwe.printTokens(tokens);
		}
		input.close();
	}
}