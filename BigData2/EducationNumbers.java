/**
 *	EducationNumbers - Wrapper class that stores the parsed information from 
 *					   Education.csv. Stores fips code, state name, area name, 
 *				       and number and percent of people with:
...
public class EducationNumbers {
	...
	// toString() method used to print out data with correct formatting 
